    ...
    return (
        <div className="flex flex-col w-40 relative">
            ...
            <div className="w-full relative">
                ...
                <button type='button' hidden={buttonHidden || true} onClick={triggerChange}  className='absolute right-2 bottom-1 border-1 bg-white text-ezblue border-ezblue px-2 py-1 text-sm'>USE {fillValue}</button>
            </div>
